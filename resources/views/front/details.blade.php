...
@section('title', 'NeoMarket Marketplace')
@section('content')
...
<header class="w-full pt-[74px] pb-[103px] relative z-0">
    <div class="container max-w-[1130px] mx-auto flex flex-col z-10">
        <div class="flex flex-col gap-4 mt-7 z-10">
            <p class="bg-[#2A2A2A] font-semibold text-belibang-grey rounded-[4px] p-[8px_16px] w-fit">{{$product->category->name}}</p>
            <h1 class="font-semibold text-[55px]">
                {{$product->name}}
            </h1>
        </div>
    </div>
